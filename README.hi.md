...
- **50+ फ़ॉन्ट, लिपि के अनुसार समूहित** — Persian, Arabic, Hebrew, Urdu, Latin,
  ...
  शीर्षकों, और कोड के लिए अलग‑अलग फ़ॉन्ट — प्रत्येक एक डाउनलोड करने योग्य वेब फ़ॉन्ट (Google Fonts)।
...
नेटवर्क अनुरोध **फ़ॉन्ट फ़ाइलें** हैं जो आपके द्वारा डाउनलोड करने योग्य फ़ॉन्ट चुनने पर Google Fonts से
