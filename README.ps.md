...
- **۵۰+ فونټونه، د لیکدود له مخې ډلبندي** — فارسي، عربي، عبري، اردو، لاتین،
  سیریلیک، دیواناګري، جاپاني، چینایي، کوریایي، تایلنډي، بنګالي — د لټون وړ، د مخکتنې لرونکي ټاکونکي او د هرې ژبې د فلټر چپس سره. د متن، سرلیکونو او کوډ لپاره جلا فونټونه — هر یو د ښکته کېدو وړ ویب فونټ (Google Fonts).
...
شبکه يي غوښتنې **د فونټ فایلونه** دي چې له Google Fonts نه راوړل کیږي کله چې تاسو یو د ښکته کېدو وړ فونټ وټاکئ. د نورو معلوماتو لپاره [PRIVACY.md](PRIVACY.md) وګورئ.
